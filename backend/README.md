...
## Project Structure
    ...
    ├── testapiautoteammem_107627  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_107627`
...
2. Clone this repo and `cd testapiautoteammem_107627`
